...
class MeterPointsApiIntegrationTests extends AbstractApiIntegrationTest {
  ...
  class GetMeterPointsTests {
    ...
    void status200() {
      ...
      meterPointTestDataService.newMeterPoint(
          m -> m.unit(unitTestDataService.newUnit(u -> u.number("12"))).number("12 635 851"));
      meterPointTestDataService.newMeterPoint(
          m -> m.unit(unitTestDataService.newUnit(u -> u.number("34"))).number("34 635 851"));
