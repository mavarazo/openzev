...
public interface AccountingMapper {
  ...
  ZevAccountingDto mapToAccountingDto(ZevAccounting zevAccounting);
  ...
  @Mapping(target = "invoices", ignore = true)
  @Mapping(target = "documents", ignore = true)
  ZevAccounting mapToAccounting(ModifiableZevAccountingDto modifiableZevAccountingDto);
  ...
  @Mapping(target = "documents", ignore = true)
  void updateAccounting(
      ModifiableZevAccountingDto modifiableAccountingDto,
      @MappingTarget ZevAccounting zevAccounting);
}
